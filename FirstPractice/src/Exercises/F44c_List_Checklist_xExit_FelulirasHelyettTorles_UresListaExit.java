...
public class F44c_List_Checklist_xExit_FelulirasHelyettTorles_UresListaExit {
    public static void main(String[] args) {
        ...
        } while ((!event.equalsIgnoreCase("X")) && !eventList.isEmpty()); // (!(element.toLowerCase().equals("x"))) : ezzel az utasítással kiváltható a két feltétel (és csak az x lenyomására fog vonatkozni, a tételekre nem).
